...
# =============================================================================
    ...
    if pilihandimensi=='1 Dimensi': # Jika opsi yang dipilih adalah 1 dimensi
        ...
        label_v1akhir = ttk.Label(frame_hasil, text='Kecepatan benda 1 setelah'
                                  ' tumbukan')                                      # Membuat Label kecepatan akhir benda 1
        ...
        label_v2akhir = ttk.Label(frame_hasil, text='Kecepatan benda 2 setelah'
                                  ' tumbukan')                                      # Membuat Label kecepatan akhir benda 2
        ...
        def gantibenda(option_benda): # Mendefinisikan fungsi untuk mengubah label sesuai dengan benda yang dipilih
            ...
            if option_benda == 'Benda 1':
                label_vakhir.config(text='Kecepatan benda 1 setelah tumbukan')
                label_vakhirhasil.config(text='Kecepatan benda 2 setelah tumbukan')
            elif option_benda == 'Benda 2':
                label_vakhir.config(text='Kecepatan benda 2 setelah tumbukan')
                label_vakhirhasil.config(text='Kecepatan benda 1 setelah tumbukan')
        ...
        label_vakhir = ttk.Label(frame_vakhir, text='Kecepatan benda 1 setelah'
                                 ' tumbukan')                                                   # Membuat Label kecepetan akhir benda 1
        ...
        label_vakhirhasil = ttk.Label(frame_hasil, text='Kecepatan benda 2 '
                                      'setelah tumbukan')                           # Membuat Label kecepatan akhir benda
